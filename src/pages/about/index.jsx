...
export default function About() {
  return (
    <Inner>
      ...
      <div className='body'>
        <p>
          Andy Lucas is an English author of action and adventure thrillers, who
          has lived and breathed adventure tales from the likes of Cussler,
          Higgins and Clancy, for years. RACE AMAZON: False Dawn is the first in
          his James Pace series, and was included in the international
          ...
          his books, all the time focusing on giving the reader a fantastic
